    ...
    <div className="min-h-screen bg-[#F8FAFC] text-[#0F172A] p-6">
      ...
      <section className="text-center max-w-3xl mx-auto mb-14">
        ...
        <p className="text-gray-600 text-lg mt-4">
          A secure and reliable platform to track revenue, manage billing cycles,
          and analyze profit & loss with clarity and precision.
        </p>
      </section>
      ...
      <div className="flex justify-center gap-6 mb-16 flex-wrap">
        <Button
          size="lg"
          className="bg-[#1E3A8A] hover:bg-[#3B82F6] text-white px-6 py-3 shadow-md"
        ...
        <Button
          size="lg"
          variant="outline"
          className="border-[#3B82F6] text-[#1E3A8A] hover:bg-[#3B82F6] hover:text-white px-6 py-3"
      ...
      <div className="grid md:grid-cols-3 gap-6 max-w-6xl mx-auto mb-16">
        ...
        <Card className="shadow-md hover:shadow-xl transition duration-300 border border-blue-100">
          <CardContent className="p-6 text-center">
            ...
            <p className="text-sm text-gray-500">
              Track all invoices, payments, and collections in real-time with complete visibility.
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="shadow-md hover:shadow-xl transition duration-300 border border-blue-100">
          <CardContent className="p-6 text-center">
            ...
            <p className="text-sm text-gray-500">
              Analyze financial performance with accurate P&L insights and cost breakdowns.
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="shadow-md hover:shadow-xl transition duration-300 border border-blue-100">
          <CardContent className="p-6 text-center">
            ...
            <p className="text-sm text-gray-500">
              Manage billing cycles, invoices, and payment schedules efficiently.
            </p>
          </CardContent>
        </Card>
      ...
      <section className="max-w-4xl mx-auto text-center mb-16">
        ...
        <p className="text-gray-600 leading-relaxed">
          Designed for businesses that need clarity in financial operations, this portal provides
          a centralized system to manage billing, monitor revenue streams, and evaluate profitability.
        </p>
      </section>
